...
// Local
import './Home.css';
import { getWallets, addWallet, setWalletFieldState } from '../../store/actions/walletActions';
...
class Home extends React.Component {
  ...
  componentDidMount = async () => {
  	...
  	if (!this.props.wallets.length) {
  		try {
  			...
  			console.error('this.props.getWallets()=>', error);
  		}
  	}
  };
  ...
  render() {
  	...
  	return (
  		<div id="Home">
  			<Fab color="primary" aria-label="Add" id="bt_addProduct" fab="true" onClick={this.onClickAddWallet}>
  				<AddIcon />
  			</Fab>
